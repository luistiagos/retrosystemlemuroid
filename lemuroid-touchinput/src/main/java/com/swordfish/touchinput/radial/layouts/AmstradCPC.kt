...
import com.swordfish.touchinput.radial.layouts.shared.SecondaryButtonKeyboard
...
@Composable
fun PadKitScope.AmstradCPCLeft(
    ...
    BaseLayoutLeft(
        ...
        secondaryDials = {
            ...
            // SELECT + START shows the virtual keyboard (cap32_combokey = "select")
            SecondaryButtonKeyboard(settings, keyCode = KeyEvent.KEYCODE_BUTTON_SELECT)
        },
    )
}

@Composable
fun PadKitScope.AmstradCPCRight(
    modifier: Modifier = Modifier,
    settings: TouchControllerSettingsManager.Settings,
) {
    BaseLayoutRight(
