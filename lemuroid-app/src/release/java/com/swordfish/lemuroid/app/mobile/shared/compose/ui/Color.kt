...
val md_theme_light_primary = Color(0xFF007A40)
val md_theme_light_onPrimary = Color(0xFFFFFFFF)
val md_theme_light_primaryContainer = Color(0xFF9EFFCA)
...
val md_theme_light_inversePrimary = Color(0xFF00FF7A)
val md_theme_light_shadow = Color(0xFF000000)
val md_theme_light_surfaceTint = Color(0xFF007A40)
val md_theme_light_outlineVariant = Color(0xFFC2C9BD)
val md_theme_light_scrim = Color(0xFF000000)

val md_theme_dark_primary = Color(0xFF00FF7A)
val md_theme_dark_onPrimary = Color(0xFF003820)
val md_theme_dark_primaryContainer = Color(0xFF005233)
val md_theme_dark_onPrimaryContainer = Color(0xFF9EFFCA)
val md_theme_dark_secondary = Color(0xFF00F0FF)
val md_theme_dark_onSecondary = Color(0xFF003D42)
